		...
		<div class="form-v10-content">
			<form class="form-detail" action="#" method="post" id="myform">
				<div class="form-left">
					...
					<div class="form-row">
						<input type="text" name="nama_pasien" id="nama_pasien" placeholder="Nama Lengkap" class="input-text" autocomplete="off" required>
					</div>
					<div class="form-row">
				...
				<div class="form-right">
					...
					<div class="form-group">
						...
						<div class="form-row form-row-2">
							<input type="text" name="tempat_lahir" id="tempat_lahir" class="input-text" placeholder="Tempat Lahir" required>
						</div>
					</div>
					<div class="form-row">
